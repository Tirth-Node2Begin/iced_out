...
export const metadata: Metadata = {
  title: "Collections",
  description: "Every Iced_out chapter, each one finite and designed to work as a single uniform.",
};

export default function CollectionsPage() {
  return (
    <PageFrame
      eyebrow="Archive / Current signal"
      lede="Each release is a finite chapter, designed to work as one uniform."
      spec={[
        { label: "Chapters", value: String(collections.length).padStart(2, "0") },
        { label: "Live now", value: "Drop 001" },
      ]}
      title={
        <>
