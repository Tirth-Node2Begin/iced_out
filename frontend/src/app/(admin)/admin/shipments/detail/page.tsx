...
import { ShipmentDetailRoute } from "@/features/17-shipping/components/shipment-detail-route";

/**
 * One record, addressed by `?id=`.
 *
 * This replaced a `[shipmentId]` segment whose `generateStaticParams` listed the
 ...
 */
export default function ShipmentDetailRoutePage() {
  return (
