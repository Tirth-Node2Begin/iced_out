...
import { Section } from "@/components/shell/admin-ui";
...
const QUEUE_CARDS = [
  { key: "ordersToConfirm", label: "Orders to confirm", icon: ShoppingBag, tone: "amber", href: "/orders" },
  { key: "paymentExceptions", label: "Payment exceptions", icon: Banknote, tone: "rose", href: "/payments" },
  { key: "readyToDispatch", label: "Ready to dispatch", icon: PackageCheck, tone: "sky", href: "/shipments/active" },
  { key: "returnsToReview", label: "Returns to review", icon: RotateCcw, tone: "violet", href: "/returns/requests" },
  { key: "stockAtRisk", label: "Stock at risk", icon: Boxes, tone: "amber", href: "/inventory/overview" },
  { key: "openTickets", label: "Open queries", icon: Headphones, tone: "sky", href: "/support" },
] as const;
