...
REM
REM  Usage:  server.bat                 http://127.0.0.1:8100
REM          server.bat 9000            another port
REM          server.bat 8100 0.0.0.0    reachable from other machines
REM
...
echo.
echo   OPEN THE CRM AT  http://127.0.0.1:3100   (not localhost:3100)
echo.
